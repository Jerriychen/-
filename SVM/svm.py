...
def calcError(svm, alpha_k):
	output_k = float(multiply(svm.alphas, svm.train_y).T * svm.kernelMat[:, alpha_k] + svm.b)     #计算机w*x+b
...
def trainSVM(train_x, train_y, C, toler, maxIter, kernelOption=('rbf', 0.5)):
...
def showSVM(svm):
	...
	for i in supportVectorsIndex:
		plt.plot(svm.train_x[i, 0], svm.train_x[i, 1], '.y')
