...
dataSet,labels = ld.createDataSet('car.data.txt')
import copy
...
trainingSet,testSet = dataSet[0:training_len],dataSet[training_len:]
myTree = createTree(trainingSet,labels,chooseBestFeatureToSplitByID3)
...
correct+=0.0
# 测试训练集准确率
print "decision Tree predict precision: %s" %(correct/len(testSet)*100),"%"